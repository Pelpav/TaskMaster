...
navLinks.forEach(link => {
  link.addEventListener('click', function(e) {
    ...
    // Affichez la section correspondante au lien sur lequel l'utilisateur a cliqué
...
$("#add-task-button, #btnAddTask").click(function (e) {
...
// Ajout de la fonction checkTasks
function checkTasks() {
...
localStorage.setItem('tasks', $("#task-list").html());
    ...
    $("#deleteicon").click(function (e) {
        $(".taskLine").remove();
        checkTasks(); // Appeler checkTasks après la suppression de toutes les tâches
...
localStorage.setItem('tasks', $("#task-list").html());
    ...
    checkTasks(); // Appeler checkTasks après l'ajout d'une tâche
});
